...
public class SimpleInterestCalculator {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("https://www.easycalculation.com/simple-interest.php");//viziteaza adresa indicata
		
		driver.manage().window().maximize();//mareste fereastra
		
		String path="C:\\Users\\Serghei.Matura\\eclipse-workspace\\SeleniumAutomation/SIdata.xlsx";//unde se afla failul excel
	
		XLUtils.setExcelFile(path, "Shee1");//se duce la pagina dorita in excelul indicat
